	...
	function only_StaffCategory(){
		...
		if( buttonStaffCategoryId == 'buttonStaffCategory00'){
			...
			introductionStaffNavi.classList.add(categoryClasses[0]);
			buttonStaffCategory[0].classList.add(categoryClasses[0]);
			...
			introductionStaffNavi.classList.add(categoryClasses[1]);
			buttonStaffCategory[0].classList.add(categoryClasses[1]);
			...
			introductionStaffNavi.classList.add(categoryClasses[2]);
			buttonStaffCategory[0].classList.add(categoryClasses[2]);
			...
			introductionStaffNavi.classList.add(categoryClasses[3]);
			buttonStaffCategory[0].classList.add(categoryClasses[3]);
			...
			introductionStaffNavi.classList.add(categoryClasses[4]);
			buttonStaffCategory[0].classList.add(categoryClasses[4]);
			...
			introductionStaffNavi.classList.add(categoryClasses[5]);
			buttonStaffCategory[0].classList.add(categoryClasses[5]);
		}
	};
